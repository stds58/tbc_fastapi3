...
// Управлять куками можно и через фронт (JS): добавлять, удалять, изменять, читать и прочее.
// Но если эти куки устанавливал бжкенд, то изменение и удаление с фронта будет невозможно. Будьте внимательны.
